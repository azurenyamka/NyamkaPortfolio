      ...
      <svg viewBox="0 0 128 128">
        <defs>
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color="#6610f2" offset="0"></stop>
            <stop stop-color="#6610f2" offset="1"></stop>
          </linearGradient>
          <filter
        ...
        <motion.path
          ...
          animate={{ pathLength: 1, pathOffset: 1, fill: "#9013fe" }}
          transition={{
            duration: 3,
            ease: "easeInOut",
            repeat: Infinity,
        ...
        <motion.path
          initial={{ pathLength: 0, pathOffset: 0, fill: "none" }}
          animate={{ pathLength: 1, pathOffset: 1, fill: "#6610f2" }}
          transition={{
            duration: 3,
            ease: "easeInOut",
            repeat: Infinity,
          ...
          fill="url(#bootstrap-original-b) #fff"
